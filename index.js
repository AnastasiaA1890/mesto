...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_Section_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/Section.js */ \"./src/components/Section.js\");\n/* harmony import */ var _components_Card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Card.js */ \"./src/components/Card.js\");\n/* harmony import */ var _components_Popup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Popup.js */ \"./src/components/Popup.js\");\n/* harmony import */ var _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/FormValidator.js */ \"./src/components/FormValidator.js\");\n/* harmony import */ var _components_PopupWithImage_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/PopupWithImage.js */ \"./src/components/PopupWithImage.js\");\n/* harmony import */ var _components_PopupWithForm_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/PopupWithForm.js */ \"./src/components/PopupWithForm.js\");\n/* harmony import */ var _components_UserInfo_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/UserInfo.js */ \"./src/components/UserInfo.js\");\n/* harmony import */ var _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/canstants.js */ \"./src/utils/canstants.js\");\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index.css */ \"./src/pages/index.css\");\n/* harmony import */ var _components_Api_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/Api.js */ \"./src/components/Api.js\");\n\n\n\n\n\n\n\n\n\n\n_components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.getInitialCards().then(function (res) {\n  var data = res.map(function (item) {\n    var newData = {\n      name: item.name,\n      link: item.link\n    };\n    return newData;\n  });\n  defaultCardList.renderItems(data);\n});\nvar profileValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.validationList, _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.formEditProfile);\nvar cardValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.validationList, _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.formAdd);\nvar avatarValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.validationList, _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.formAvatarEdit);\nvar popupImage = new _components_PopupWithImage_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('#open-photo', openEditProfilePopup);\nvar popupEdit = new _components_PopupWithForm_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('#edit-profile', handleProfileFormSubmit);\nvar popupAdd = new _components_PopupWithForm_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('#add-card', renderAddedCard);\nvar popupAvatar = new _components_PopupWithForm_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('#avatar', handleAvatarSubmit);\nvar popupDelete = new _components_Popup_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('#delete-card', openDeleteCardPopup);\nvar userInfo = new _components_UserInfo_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"]({\n  name: '.profile__name',\n  about: '.profile__description',\n  avatar: '.profile__avatar'\n});\nprofileValidator.enableValidation();\ncardValidator.enableValidation();\navatarValidator.enableValidation(); //Функция создания карточки\n\nfunction createCard(item) {\n  var newCard = new _components_Card_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](item, '#elements-items', handleCardClick, likeCount).generateCard();\n  return newCard;\n}\n\nfunction likeCount() {\n  return _components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.likeCounter();\n} //Отрисовка элементов на странице\n\n\nvar defaultCardList = new _components_Section_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n  renderer: function renderer(item) {\n    defaultCardList.addItem(createCard(item));\n  }\n}, _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.elements); //Окно EditProfilePopup\n//Функция открытия окна EditProfilePopup\n\nfunction openEditProfilePopup() {\n  var userData = userInfo.getUserInfo();\n  _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.popupFieldName.value = userData.name;\n  _utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.popupFieldDescription.value = userData.about;\n  profileValidator.resetErrors();\n  popupEdit.open();\n} //Функция сохранения данных полей формы EditProfilePopup\n\n\nfunction handleProfileFormSubmit(data) {\n  _components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.editProfile(data).then(function (res) {\n    console.log(res);\n    userInfo.setUserInfo(res);\n    popupEdit.close();\n  });\n} //Окно AddCardPopup\n\n\nfunction openAddCardPopup() {\n  cardValidator.disableButton();\n  popupAdd.open();\n} //Функция добавления новой карточки\n\n\nfunction renderAddedCard(data) {\n  _components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.createCard(data).then(function (res) {\n    var newCard = {\n      name: data.name,\n      link: data.link\n    };\n    defaultCardList.addItem(createCard(newCard));\n    popupAdd.close();\n  });\n}\n\nfunction openAvatarPopup() {\n  avatarValidator.disableButton();\n  popupAvatar.open();\n}\n\nfunction handleAvatarSubmit(data) {\n  _components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.editAvatar(data).then(function (res) {\n    userInfo.setAvatar(res);\n    popupAvatar.close();\n  });\n}\n\nfunction openDeleteCardPopup(data) {\n  popupDelete.open(createCard(data));\n}\n\nfunction handleCardClick(data) {\n  popupImage.open(data);\n}\n\n_components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.getUserData().then(function (res) {\n  return res;\n});\n\nfunction renderPage() {\n  Promise.all([_components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.getUserData(), _components_Api_js__WEBPACK_IMPORTED_MODULE_9__.api.getInitialCards()]).then(function (res) {\n    userInfo.setUserInfo(res[0]);\n    userInfo.setAvatar(res[0]);\n    defaultCardList.renderItems(res[1]);\n  });\n}\n\nrenderPage(); //Вызов функции открытия окна EditProfilePopup\n\n_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.profilePopupButton.addEventListener('click', openEditProfilePopup); //Вызов функции открытия окна AddCardPopup\n\n_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.cardPopupButton.addEventListener('click', openAddCardPopup);\n_utils_canstants_js__WEBPACK_IMPORTED_MODULE_7__.avatarPopupButton.addEventListener('click', openAvatarPopup);\npopupImage.setEventListeners();\npopupEdit.setEventListeners();\npopupAdd.setEventListeners();\npopupDelete.setEventListeners();\npopupAvatar.setEventListeners();\n\n//# sourceURL=webpack://mesto/./src/pages/index.js?");
